...
; auto
[button name="role_button" role="auto" graphic="../others/plugin/theme_kopanda_12/image/button/auto.png" enterimg="../others/plugin/theme_kopanda_12/image/button/auto2.png" x="125" y="863"]

; skip
[button name="role_button" role="skip" graphic="../others/plugin/theme_kopanda_12/image/button/skip.png" enterimg="../others/plugin/theme_kopanda_12/image/button/skip2.png" x="225" y="863"]

; log
[button name="role_button" role="backlog" graphic="../others/plugin/theme_kopanda_12/image/button/log.png" enterimg="../others/plugin/theme_kopanda_12/image/button/log2.png" x="325" y="863"]

; menu
[button name="role_button" role="menu" graphic="../others/plugin/theme_kopanda_12/image/button/menu.png" enterimg="../others/plugin/theme_kopanda_12/image/button/menu2.png" x="425" y="863"]
